(function () {
  ...
  const articles = {
    shangao: {
      ...
      body: [
        '<p>2026 年 1 月 26 日，山东高速工程咨询集团有限公司景国建博士与牛腾经理一行莅临中大恒建，双方围绕产品研发、技术优势与场景应用等核心议题，展开了深入的技术交流与战略研讨。</p>',
        '<h4 class="mt-4">嘉宾简介，实力彰显</h4>',
        '<p class="mt-3">景国建博士长期深耕交通基础设施建设、工程材料研发、智能建造技术等前沿领域，不仅具备深厚的理论功底，更主导参与了多项重大工程的技术攻关与咨询工作，在行业内颇具影响力。</p>',
        '<p class="mt-3">牛腾经理拥有丰富的项目实战经验与卓越的管理才能，深谙工程咨询市场规律，在项目统筹、资源整合、客户服务与市场开拓等方面业绩斐然，是连接技术创新与市场实践的重要桥梁。</p>',
        ...
        '<h4 class="mt-4">技术探讨，智慧碰撞</h4>',
        '<p class="mt-3">交流中，双方聚焦中大恒建在交通与建筑领域的核心材料及解决方案，开展了系统性的成果展示与前沿关键技术攻坚研讨，重点围绕两大方向深入交流：</p>',
        '<p class="mt-3">1、特种工程材料：包括用于路面快速修复的「混凝土基面薄层快速修复技术」以及高耐久性的「MMA彩色防滑材料」。</p>',
        '<p class="mt-3">2、高性能混凝土产品：涵盖「UHPC超高性能混凝土」在古建筑、旧危桥穿涵特种加固技术及工业化预制构件方面的创新应用。</p>',
        '<p class="mt-3">双方就产品研发突破、核心性能亮点，以及在桥梁、道路、市政建筑等领域的应用前景展开建设性探讨，在思想碰撞中凝聚前瞻共识，共同开拓合作新空间。</p>',
    ...
    korea: {
      ...
      body: [
        '<h4>开篇引文</h4>',
        '<p class="mt-3">历时3天，韩国第13届国际新材料技术大展(INTRA)在首尔COEX会展中心圆满落幕。作为韩国唯一商务级新材料综合展会，本届展会汇聚全球200余个尖端材料领域企业，得到韩国产业通商资源部专项支持。</p>',
        '<p class="mt-3">本次展会，<strong>中大恒建</strong>携高强无收缩灌浆料（CGM）、风电专用灌浆料（HPG）惊艳亮相，吸引了众多新老朋友驻足交流，收获满满！现在，让我们一起回顾那些精彩瞬间！</p>',
        ...
        '<p class="mt-3">在中大恒建的展区，访客感受到的不仅是产品，更是新材料为建筑未来勾勒的全新可能。因此，镜头所记录的，不只是一次次讲解，更是一场场思维碰撞与价值共识的起点。我们深信，这些在展会中播下的合作种子，必将成长为推动行业进步的参天大树。</p>',
        '<p class="mt-3">展区集中呈现了包括高强无收缩灌浆料（CGM）、风电专用灌浆料（HPG）、海上风电专用灌浆料等全面覆盖现代建筑与工程材料的关键领域。</p>',
        '<h4 class="mt-4">感恩致谢与未来展望</h4>',
        '<p class="mt-3">展会有期，征程无限。此次韩国之行，我们满载海外客户与伙伴的认可与赞誉，也再次坚定了我们走向全球市场的信心与步伐。</p>',
        '<p class="mt-3">中大恒建（北京）新材料科技有限公司始终以材料科学与工程学为根基，坚持高科技创新路线，构建了集研发、生产与应用于一体的全产业链创新体系，聚焦建筑新材料领域的技术突破与产业革新。我们以「双轮驱动」战略为核心竞争力，通过新材料研发与新技术转化的深度融合，持续夯实企业在全球建筑新材料领域的科创实力。</p>',
        '<p class="mt-3">未来，中大恒建将继续以“创新科技，筑联全球”为愿景，与全球伙伴携手，共同推动建筑建材行业向更高质量、更可持续的方向发展。</p>'
      ],
